...
public class Constants {
    public static final Regions APPSYNC_REGION = Regions.US_WEST_2; // TODO: Update the region to match the API region
    public static final String APPSYNC_API_URL = "https://API-URL/graphql"; // TODO: Update the endpoint URL as specified on AppSync console
    ...
    public static final Regions COGNITO_REGION = Regions.US_WEST_2; // TODO: Update the region to match the Cognito Identity Pool region
